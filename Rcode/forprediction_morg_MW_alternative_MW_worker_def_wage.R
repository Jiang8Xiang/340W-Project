...
load(file=paste0(data_directory, "prediction_model_1979_2019_wage.RData"))
...
write.dta(datatemp, paste0(data_directory, "CPSmorg_MLpredprobs_1979_2019_new_wage.dta"))
